...
function wp_starter_enqueue_assets()
{
    ...
    // Global styles
    wp_enqueue_style('wp_starter-global', get_template_directory_uri() . '/dist/assets/global_style.css', array(), $theme_version);
    wp_enqueue_style('wp_starter-app-style', get_template_directory_uri() . '/dist/assets/app.css', array(), $theme_version);
}
